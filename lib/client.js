...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.sui-input{box-sizing:border-box;width:100%;height:34px;border-radius:8px;padding:0 12px;font-size:13px;line-height:20px;background:var(--dsw-alias-bg-layer-3,#353638);color:var(--dsw-alias-label-primary,#f9fafb);border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,0.12));}', // 0.4.0：官方输入模型（34px/圆角8/层3）
      '.sui-input:focus{outline:none;border-color:var(--dsw-alias-brand-primary,#f9fafb);}',
      '.sui-textarea{box-sizing:border-box;width:100%;border-radius:8px;padding:8px 12px;font-size:13px;font-family:var(--ds-font-family-code,ui-monospace,Consolas,monospace);resize:vertical;background:var(--dsw-alias-bg-layer-3,#353638);color:var(--dsw-alias-label-primary,#f9fafb);border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,0.12));}',
      ...
      '.sui-pfield-input:focus-visible{outline:none;border-color:var(--dsw-alias-brand-primary,#679efe);}',
      '.sui-pfield-input:disabled{color:var(--dsw-alias-label-tertiary,#adb2b8);cursor:default;}',
