...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.sui-btn{border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5;cursor:pointer;background:var(--dsw-alias-bg-layer-2,#2c2c2e);color:var(--dsw-alias-label-primary,#f9fafb);border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,0.12));}', // 0.4.0：官方按钮模型（圆角8）
      '.sui-btn:hover{background:var(--dsw-alias-bg-layer-3,#353638);}',
      '.sui-btn:disabled{opacity:0.4;cursor:default;}', // 0.4.0：官方禁用态 opacity .4
