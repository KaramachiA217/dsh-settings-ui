...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.sui-input{box-sizing:border-box;width:100%;height:34px;border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5;background:var(--dsw-alias-bg-layer-3,#353638);color:var(--dsw-alias-label-primary,#f9fafb);border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,0.12));}', // 0.4.0：官方输入模型（34px/圆角8/层3）
      ...
      '.sui-pcard-desc{font-size:13px;line-height:1.5;color:var(--dsw-alias-label-tertiary,#adb2b8);}',
      ...
      '.sui-pcard-readonly{margin:12px 0 0;font-size:12px;line-height:1.5;color:var(--dsw-alias-label-tertiary,#adb2b8);}',
      ...
      '.sui-pcard-discard,.sui-pcard-save{appearance:none;border:1px solid transparent;border-radius:8px;padding:5px 14px;font:inherit;font-size:13px;line-height:1.5;cursor:pointer;}',
      ...
      '.sui-pfield-label{flex:1;min-width:0;font-size:13px;font-weight:500;line-height:1.5;color:var(--dsw-alias-label-primary,#f9fafb);}',
      '.sui-pfield-input{box-sizing:border-box;width:100%;height:34px;padding:0 12px;border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,0.12));border-radius:8px;background:var(--dsw-alias-bg-layer-3,#353638);font:inherit;font-size:13px;line-height:1.5;color:var(--dsw-alias-label-primary,#f9fafb);}',
      ...
      '.sui-pfield-hint{margin:0;font-size:12px;line-height:1.5;color:var(--dsw-alias-label-tertiary,#adb2b8);}',
      '.sui-pfield-reset{border:none;background:none;padding:0;font:inherit;font-size:12px;line-height:1.5;color:var(--dsw-alias-label-secondary,#cfd3d6);cursor:pointer;}',
